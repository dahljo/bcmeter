...
heating=False#Enable heating? 
sample_time=300 #Time in seconds between to samples. 
sample_count = 1000 #This many samples are take for each datapoint. 
airflow_per_minute=0.075#Airflow per minute in liter
...
pump_dutycycle=20#Power 0-100 for the pump
pwm_freq=20#Pulse width modulation frequency for pump duty cycle
