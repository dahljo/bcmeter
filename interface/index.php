...
<input type="submit" name="reloadpage" value="Reload Data" class="btn btn-primary"/>
<input type="submit" name="saveGraph" value="Download Data" class="btn btn-primary bootbox-accept"/>
<a href="/logs"><input type="submit" name="oldLogs" value="Access all logs" class="btn btn-primary bootbox-accept"/></a>
</form>
...
<input type="submit" name="editor" value="Edit Parameters" class="btn btn-info"/>
...
var dialog = bootbox.dialog({
		...
		buttons: {
				...
				ok: {
						...
						callback: function(){
								window.location.href='status.php?status=shutdown';
...
var dialog = bootbox.dialog({
		...
		buttons: {
				...
				ok: {
						...
						className: 'btn-danger',
						callback: function(){
								window.location.href='status.php?status=reboot';
...
var dialog = bootbox.dialog({
		title: 'Stop logging',
		message: "<p>This will stop the current measurement.</p>",
		size: 'small',
		buttons: {
				cancel: {
						label: "No",
				...
				ok: {
						...
						callback: function(){
							...
							$.ajax({
								...
								data: 'exec_debug',
								success: function(response){
									 window.location.href='status.php?status=debug';
								}
						 });
...
var dialog = bootbox.dialog({
		title: 'Start new log?',
		message: "<p>This will start a new log. It will take 20-30 seconds for the new chart to appear. </p>",
		size: 'small',
		buttons: {
				cancel: {
						label: "No",
...
var dialog = bootbox.dialog({
		...
		message: "<p>If you run the update, the most recent files will be downloaded. </p>",
		size: 'medium',
		buttons: {
				cancel: {
						label: "No",
				...
				ok: {
						...
						className: 'btn-danger',
						callback: function(){
								window.location.href='status.php?status=update';
